...
Unity 에디터 → `Window > Package Manager > + > Add package from git URL...` 에 아래 URL을 붙여넣기:

또는 `Packages/manifest.json`의 `dependencies`에 직접 추가할 수도 있습니다.
...
**Package Manager URL:**
```
https://github.com/tjdtjq5/unity-packages.git?path=com.tjdtjq5.editor-toolkit#editor-toolkit/v1.1.2
```
...
**Package Manager URL:**
```
https://github.com/tjdtjq5/unity-packages.git?path=com.tjdtjq5.ugs-manager#ugs-manager/v1.3.0
```
...
**Package Manager URL:**
```
https://github.com/tjdtjq5/unity-packages.git?path=com.tjdtjq5.ui-framework#ui-framework/v1.0.1
```
...
| 기능 | 내용 |
|------|------|
| Manager 윈도우 | 워크트리 생성/목록/삭제, 메인 실행 (Tools > Claude Code > Manager) |
| 툴바 버튼 | ✦ Claude [N] 벳지 (좌클릭: Manager, 우클릭: 설정) |
| 터미널 런처 | Windows Terminal 탭 / PowerShell fallback |
| 설정 | 드롭다운 인자 선택, 탭 색상, AutoLaunch (EditorPrefs 기반) |

**Package Manager URL:**
```
https://github.com/tjdtjq5/unity-packages.git?path=com.tjdtjq5.claude#claude/v0.3.0
```
...
```json
"com.tjdtjq5.claude": "https://github.com/tjdtjq5/unity-packages.git?path=com.tjdtjq5.claude#claude/v0.3.0"
```
</details>
