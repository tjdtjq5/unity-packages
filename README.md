...
```json
"com.tjdtjq5.addrx": "https://github.com/tjdtjq5/unity-packages.git?path=com.tjdtjq5.addrx#addrx/v0.1.6"
```
...
```json
"com.tjdtjq5.suparun": "https://github.com/tjdtjq5/unity-packages.git?path=com.tjdtjq5.suparun#suparun/v0.4.1"
```
