...
namespace Tjdtjq5.SupaRun.Editor
{
    public class SupabaseSetup
    {
        ...
        public SupabaseSetup(SupaRunDashboard dashboard) => _dashboard = dashboard;
        ...
        void OnProjectSelected(SupaRunSettings settings, SupabaseManagementApi.ProjectInfo project)
        {
            // URL 자동 설정
        ...
        void DrawConnectionTest(SupaRunSettings settings)
        {
            switch (_testState)
            {
                case TestState.None:
